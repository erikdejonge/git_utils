...
alias upgrade="sudo date; brew update; brew upgrade; brew doctor; brew cleanup -s --force; sudo gem update bropages; gcloud -q components update; sudo python /Users/rabshakeh/workspace/research/upgrade_python_packs.py"
