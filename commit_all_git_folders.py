...
def main():
    ...
    if os.path.exists("/home/rabshakeh/workspace/git_utils/exclude_dirs"):
        excludes = [x.strip() for x in open("/home/rabshakeh/workspace/git_utils/exclude_dirs").read().split("\n") if x.strip()]
    ...
    dir_list = []
    os.path.walk("/home/rabshakeh/workspace", find_git_repos, dir_list)


    #dir_list = [os.path.join("/home/rabshakeh/workspace", x.lstrip("./")) for x in dir_list]
    print "committing"
